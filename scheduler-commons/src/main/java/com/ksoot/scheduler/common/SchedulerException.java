...
public class SchedulerException extends NestedRuntimeException {
   ...
   *     subclass of {@link org.quartz.SchedulerException}, but can also be a JNDI NamingException
   *     or the like.
   */
   ...
   * {@code jakarta.jms} exceptions.
   *
   * @param cause the cause of the exception. This argument is generally expected to be a proper
   *     subclass of {@link org.quartz.SchedulerException}.
   */
  ...
  public String getMessage() {
    ...
    if (cause instanceof org.quartz.SchedulerException schedulerException) {
      ...
      if (nestedCause != null) {
        ...
        if (nestedCauseMessage != null
            && (causeMessage == null || !causeMessage.contains(nestedCauseMessage))) {
