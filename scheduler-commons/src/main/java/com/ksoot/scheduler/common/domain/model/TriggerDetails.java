...
public class TriggerDetails {
    ...
    public static TriggerDetails of(final Trigger trigger, final TriggerState triggerState,
        ...
        OffsetDateTime fireTime = fireDate == null ? null
                : fireDate.toInstant().atOffset(ZoneOffset.UTC);
        OffsetDateTime nextFireTime = nextFireDate == null ? null
                : nextFireDate.toInstant().atOffset(ZoneOffset.UTC);
//        Duration repeatInterval = AbstractSchedulerService.getJobFrequency(trigger);
        return of(fireTime, nextFireTime, repeatInterval == null ? null : Frequency.of(repeatInterval),
                triggerState);
    }
}
